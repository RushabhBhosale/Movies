...
export default function Home({
  ...
  useEffect(() => {
    if (watchlist) {
      const res = watchlist?.filter(
        (movie: MTV) => movie?.status === "Watching"
      );
      setWatching(res);
    }
  }, [watchlist]);
              ...
              <div className="flex gap-3 no-scrollbar overflow-auto">
                {watching?.length > 0 ? (
                  ...
                  <div className="space-y-4 w-full">
                    ...
                    <div className="bg-zinc-800/50 backdrop-blur-sm rounded-xl border border-zinc-700/50 p-6 text-center">
                      <p className="text-zinc-300 text-sm md:text-base">
                        Your watchlist is empty! Start adding movies or TV shows
                        to continue your entertainment journey.
                      </p>
              ...
              <div className="bg-zinc-800/50 backdrop-blur-sm rounded-2xl border border-zinc-700/50 overflow-hidden">
                ...
                <div className="p-6 text-center">
                  <p className="text-zinc-300 text-sm">
                    Your watchlist is empty! Add some movies or TV shows to keep
